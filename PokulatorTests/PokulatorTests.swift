...
//        XCTAssertEqual(numValidSuitSets(cards: set), 990)
    ...
    func testHandDetection() {
        ...
        let sf2 = Array<Card>(arrayLiteral: Card(value: 1, suit: .clubs), Card(value: 10, suit: .clubs), Card(value: 11, suit: .clubs), Card(value: 12, suit: .clubs), Card(value: 13, suit: .clubs), Card(value: 10, suit: .clubs))
